    ...
    >
      <div>
        ...
        <p
          ...
          "
        >
          Run an inspection to populate analytics.
        </p>
      </div>
    </div>
  );
...
function Analytics() {
  ...
  const insightChangeText =
    weeklyData.length >= 2
      ? `${trendIsPositive ? "+" : ""}${trendChange.toFixed(
          1
        )} pts`
      : "Live data";
      ...
      >
        <div>
          ...
          >
            ...
            identify risk patterns, and make
        ...
        >
          ...
          <span className="ml-1 h-1 w-1 rounded-full bg-slate-300" />
      ...
      >
        ...
        <div className="p-4 sm:p-6">
          ...
          >
            ...
            <MiniStat
              label="Lowest score"
              value={formatPercent(lowestScore)}
      ...
      >
        ...
        >
          ...
          >
            ...
            {totalInspections.toLocaleString()} total
          </div>
        </div>
